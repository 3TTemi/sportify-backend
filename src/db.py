...
class Game(db.Model):
    ...
    ticket_price = db.Column(db.Integer) # NEWLY ADDE D
    ...
    def serialize(self):
        ...
        """
        sample_tickets = random.sample(self.tickets, min(len(self.tickets), 3))
        return {
            "id": self.id,
            "sport": self.sport,
            "sex": self.sex,
            ...
            "sample_tickets": [t.serialize() for t in sample_tickets],
